...
public class CartScreenController {
    ...
    void btnRemovePressed(ActionEvent event) {
        ...
        costLabel.setText(String.valueOf(this.cart.getTotalCost()));
    }

    void showFilteredMedia(String tf) {
        ObservableList<Media> list = cart.getItemOrdered();
    ...
    void updateCost() {
        costLabel.setText(String.valueOf(cart.getTotalCost()));
    }
    ...
    private void initialize() {
        ...
        cart.getItemOrdered().addListener(new ListChangeListener<Media>() {
            @Override
